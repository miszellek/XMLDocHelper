...
uses xmldom, XMLDoc, XMLIntf, XMLDocHelper;
...
const
  artNamespace = 'http://www.webucator.com/Artist';
...
begin
  RegisterChildNode('art:Name', TXMLName);
  inherited;
end;
...
begin
  Result := ChildNodes['art:Name'] as IXMLName;
end;
